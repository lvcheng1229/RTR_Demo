...
public:
	...
	{			
		ShadowMapShader =new Shader("../../Core/ESM/ShadowMapShader.vert", "../../Core/ESM/ShadowMapShader.frag");

		SecondShader =new Shader("../../Core/ESM/secondShader.vert", "../../Core/ESM/secondShader.frag");
