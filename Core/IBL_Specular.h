#ifndef IBLSPECULAR_H
#define IBLSPECULAR_H
#include<direct.h>
#include"RenderLoop.h"
class IBL_Specular:public RenderLoop
{
public:
	IBL_Specular() {
		initDemo();
	...
	{		
		...
		glDepthFunc(GL_LEQUAL); // set depth function to less than AND equal for skybox depth trick.
								...
								// -------------------------
		pbrShader = new Shader("../../Core/IBL/pbr.vert", "../../Core/IBL/pbr_spec.frag");
		...
		Shader prefilterShader("../../Core/IBL/cubemap.vert", "../../Core/IBL/prefilter.frag");
		brdfShader= new Shader("../../Core/IBL/brdf.vert", "../../Core/IBL/brdf.frag");
	...
	void DrawUI()
	{
		...
		ImGui::Begin("IBL_Specular", &show_window, ImGuiWindowFlags_MenuBar);
