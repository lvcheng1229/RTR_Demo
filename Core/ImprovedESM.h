...
#ifndef ImprovedESM_H
#define ImprovedESM_H
#include<direct.h>
#include"RenderLoop.h"
class ImprovedESM:public RenderLoop
{
public:
	ImprovedESM() {
		initDemo();
	...
	void initDemo()
	{
		SetDemoName("ImprovedESM");
		lightPos = glm::vec3(-2.0f, 4.0f, -1.0f);
	}

	void SettingBeforLoop()
	{			
		ShadowMapShader =new Shader("../../Core/ImprovedESM/ShadowMapShader.vert", "../../Core/ImprovedESM/ShadowMapShader.frag");

		SecondShader =new Shader("../../Core/ImprovedESM/secondShader.vert", "../../Core/ImprovedESM/secondShader.frag");
	...
	void DrawUI()
	{
		...
		ImGui::Begin("ImprovedESM", &show_window, ImGuiWindowFlags_MenuBar);
		...
		ImGui::Text("prvent light leak problem\nlarge c value will be usefull");
		ImGui::SliderFloat("C", &c,0.0f,250.0f);
